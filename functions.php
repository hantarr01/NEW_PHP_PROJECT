...
function test_scripts() {
	...
	wp_enqueue_style( 'materialize', get_template_directory_uri() .
	 '/materialize.min.css', true );
	...
	wp_enqueue_script( 'bxslider', get_template_directory_uri() .
	 '/https://cdn.jsdelivr.net/bxslider/4.2.12/jquery.bxslider.min.js', array('jquery.js'), true );

	wp_enqueue_script( 'script', get_template_directory_uri() .
	 '/https://cdnjs.cloudflare.com/ajax/libs/tether/1.2.0/js/tether.min.js', array('jquery.js'), true );

	wp_enqueue_script( 'script', get_template_directory_uri() . '/js/script.js', array('jquery.js'), true );
